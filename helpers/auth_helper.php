...
//
// Loaded by index.php before any controller runs, so a controller can call
// require_role() as its first line and trust the session from then on.
//
...
// CSRF protection. Included here, after the session exists, so the POST guard
// inside csrf_helper.php runs for every request the front controller handles.
